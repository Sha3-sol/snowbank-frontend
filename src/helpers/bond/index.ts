...
export const mimSdog = new LPBond({
  ...
  lpUrl:
    "https://traderjoexyz.com/#/pool/0x130966628846BFd36ff31a822705796e8cb8C18D/0xdE9E52F1838951e4d2bb6C59723B003c353979b6",
});

export const avaxSb = new CustomLPBond({
  name: "avax_sb_lp",
  displayName: "SB-FTM LP",
  bondToken: "FTM",
  ...
  lpUrl:
    "https://traderjoexyz.com/#/pool/FTM/0x7d1232b90d3f809a54eeaeebc639c62df8a8942f",
});
